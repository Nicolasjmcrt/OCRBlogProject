					...
					<tbody class="tbody-dark">
        				<tr>
          					...
          					<td class="text-center">
            					<span class="badge  <?php echo ($lg['publication'])?'badge-success':'badge-danger'?>"><?php echo ($lg['publication'])?'oui':'non'?></span>
          					</td>
         					<td class="text-center">{{ article.update_date }}
          					</td>
          					<td class="text-center">
          					<!--Renvoi vers la page modifier-->
            					<a href="users.php?puserId={{ article.article_id }}">	<img src="images/pen.png" style="width: 25px;" alt=""></a>
          					</td>
          					<td class="text-center">
           						<button type="button" class="trash-btn" data-toggle="modal" data-target="#myModal" rel="{{ article.article_id }}" title="<?php echo $lg['title'];?>">
